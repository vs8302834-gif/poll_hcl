...
function Results() {
  ...
  const fetchResults = async () => {
    try {
      const response = await fetch(
        `http://localhost:8080/api/polls/share/${shareToken}/results`
      );
  ...
  useEffect(() => {
    ...
    const websocket = new WebSocket(
      `ws://localhost:8080/api/polls/share/${shareToken}/ws`
    );
  ...
  const handleChangeExpiration =
    async () => {
      ...
      try {
        ...
        const response =
          await fetch(
            `http://localhost:8080/api/polls/${shareToken}/expiration`,
            {
              method: "PUT",
  ...
  const handleClosePoll =
    async () => {
      ...
      try {
        const response =
          await fetch(
            `http://localhost:8080/api/polls/${shareToken}/close`,
            {
              method: "POST",
  ...
  const handleOpenPoll =
    async () => {
      ...
      try {
        const response =
          await fetch(
            `http://localhost:8080/api/polls/${shareToken}/open`,
            {
              method: "POST",
